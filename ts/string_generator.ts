 ...
 * @oeis A003849
 */
export function generate_fibonacci_word(k : number) : string {
	if(k == 0) return "b";
 ...
 * @oeis A080843
 */
export function generate_tribonacci_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A010060
 */
export function generate_thue_morse_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A064990
 */
export function generate_mephisto_waltz_word(k : number) : string {
    if(k == 0) return "a";
 ...
 *
 */
export function generate_vtm_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A316829
 */
export function generate_sierpinski_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A171588
 */
export function generate_pell_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A049320
 */
export function generate_chacon_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A308187
 */
export function generate_von_neumann_word(k : number) : string {
    if(k == 0) return "a";
...
export function rudin_shapiro_preword(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A020987
 */
export function generate_rudin_shapiro_word(k : number) : string {
    if(k == 0) return "a";
 ...
 * @oeis A086747
 */
export function generate_baum_sweet_word(k : number) : string {
 ...
 * @oeis A000002
 */
export function generate_kolakoski_word(k : number) : string {
    if(k == 0) return "ab";
